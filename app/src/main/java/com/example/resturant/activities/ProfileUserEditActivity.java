...
public class ProfileUserEditActivity extends AppCompatActivity {
...
EditText  editTextName, editTextPhone,editTextAddress, editTextEmail,editTextPassword;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editTextPhone = findViewById(R.id.p_UserPhoneEt);
        editTextAddress = findViewById(R.id.L_AddressEt);
        editTextEmail = findViewById(R.id.L_emailE);
        editTextPassword = findViewById(R.id.L_passwordE);
                ...
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        for(DataSnapshot ds :snapshot.getChildren())
                        {
                            ...
                            try {
                                Picasso.get().load(ProfileImg).placeholder(R.drawable.ic_baseline_person_24).into(imageViewPro);
                            }catch (Exception e)
                            {
                                imageViewPro.setImageResource(R.drawable.ic_baseline_person_24);
                            }
                        }
                    }
            ...
            reference.child(auth.getUid()).updateChildren(hashMap)
                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void aVoid) {
                            pd.dismiss();
                            Toast.makeText(ProfileUserEditActivity.this, "updated Successfully", Toast.LENGTH_SHORT).show();
                        }
                    }).addOnFailureListener(new OnFailureListener() {
                @Override
                public void onFailure(@NonNull Exception e) {
                    pd.dismiss();
                    Toast.makeText(ProfileUserEditActivity.this, ""+e.getMessage(), Toast.LENGTH_SHORT).show();
                }
            });
