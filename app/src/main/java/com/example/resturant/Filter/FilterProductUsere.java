...
public class FilterProductUsere extends Filter {
    private AdapterProdcutUser adapterProductUser;
    private ArrayList<ModelProduct> productArrayList;

    public FilterProductUsere(AdapterProdcutUser adapterProductUser, ArrayList<ModelProduct> productArrayList) {
    ...
    protected void publishResults(CharSequence charSequence, FilterResults filterResults) {
        adapterProductUser.productsList=(ArrayList<ModelProduct>)filterResults.values;
